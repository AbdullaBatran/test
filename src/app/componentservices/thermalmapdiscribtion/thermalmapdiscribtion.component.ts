...
@Component({
  selector: 'app-thermalmapdiscribtion',
  templateUrl: './thermalmapdiscribtion.component.html',
  styleUrl: './thermalmapdiscribtion.component.scss'
})
export class ThermalmapdiscribtionComponent {
  downloadPdf() {
