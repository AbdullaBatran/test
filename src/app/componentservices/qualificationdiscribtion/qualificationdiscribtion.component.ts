...
@Component({
  selector: 'app-qualificationdiscribtion',
  templateUrl: './qualificationdiscribtion.component.html',
  styleUrl: './qualificationdiscribtion.component.scss'
})
export class QualificationdiscribtionComponent {
  downloadPdf() {
    ...
    html2canvas(data!).then((canvas) => {
      ...
      pdf.save('Qualification-Services.pdf');
    });
  }
}
