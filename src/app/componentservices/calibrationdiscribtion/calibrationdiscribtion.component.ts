...
@Component({
  selector: 'app-calibrationdiscribtion',
  templateUrl: './calibrationdiscribtion.component.html',
  styleUrl: './calibrationdiscribtion.component.scss'
})
export class CalibrationdiscribtionComponent {
...
downloadPdf() {
  ...
  html2canvas(data!).then((canvas) => {
    ...
    pdf.save('Calibration-Services.pdf');
  });
}
