...
@Component({
  selector: 'app-skarpthub',
  templateUrl: './skarpthub.component.html',
  styleUrl: './skarpthub.component.scss'
})
export class SkarpthubComponent {
  isDropdownVisible = false; // Initially the dropdown is hidden
  issecounddropdowen = false;
  ...
  sctoggleDropdown() {
    this.issecounddropdowen = !this.issecounddropdowen;
  }
